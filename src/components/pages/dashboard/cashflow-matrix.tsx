    ...
    <div className="px-5">
      <div className="rounded-2xl border border-[var(--color-border)] bg-[var(--color-card)] p-4">
        <div className="flex items-center justify-between">
          <h2 className="text-[13px] font-semibold text-[var(--color-foreground)]">Cashflow</h2>
        ...
        <div className="mt-3 flex gap-4">
          <div>
            ...
            <p className="font-financial text-[14px] font-bold text-[var(--color-foreground)]">{formatCurrency(totalIn)}</p>
          </div>
          <div>
            ...
            return (
              <div key={d.month} className="flex flex-1 flex-col items-center gap-1.5">
                <div className="flex w-full items-end justify-center gap-[2px]" style={{ height: 80 }}>
                  <div
                    className="w-full max-w-[10px] rounded-t bg-[var(--color-foreground)] transition-all duration-500"
